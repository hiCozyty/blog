<div class="contact-container">
	...
	<div class="contact-item">
		<h2>
			<a href="https://signal.me/#u/cozyty.443" target="_blank" rel="noopener noreferrer">
				Signal Contact
			</a>
		</h2>
		<img
...
<style>
	...
	h2 a {
		...
		transition:
			...
			/* Added transform for movement */ box-shadow 0.1s ease-out; /* Added box-shadow for depth */
